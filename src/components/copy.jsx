...
const Landing = () => {
  ...
  return (
    <div ref={landingRef}>
      {/* ✅ FIX 1: Use min-h-screen to prevent shrinking */}
      <div className="bg-[#f8f3ec] min-h-screen w-full flex items-center justify-between px-25 mt-10 gap-10">
        <div className="flex flex-col justify-center w-130 mt-20">
          <h2 className="landing-item font-semibold text-5xl">Find anything.</h2>
          <h2 className="landing-item font-semibold text-5xl mb-5">Protect everything.</h2>
          <p className="landing-item text-[#524a3ed1] text-xl font-normal leading-8">
          ...
          <div className="flex items-center mt-8 gap-10">
            <div className="relative flex items-center space-x-3">
              <button className="landing-item px-13 py-6 bg-blue-600 text-white font-semibold rounded-2xl cursor-pointer">
                What's new with Dash
              </button>
              <FaArrowRight className="absolute top-7 right-3 mr-5 text-white" />
            </div>
            <div className="flex items-center gap-2 font-semibold">
              <button className="landing-item underline font-semibold text-xl cursor-pointer text-black">
                Try Dropbox free
              </button>
              <FaArrowRight />
            </div>
        ...
        {/* ✅ FIX 2: Reserve space for video with bg placeholder */}
        <div className="flex items-center justify-center w-[60%] min-h-screen bg-black">
          <video
            ...
            className="h-full w-full object-cover landing-video"
            autoPlay
            muted
            loop
            playsInline
      ...
      <div className="flex flex-col items-center justify-center min-h-screen w-full bg-[#f8f3ec]">
      ...
      <div className="flex flex-col items-center justify-center min-h-screen w-full bg-[#f8f3ec] mb-20">
